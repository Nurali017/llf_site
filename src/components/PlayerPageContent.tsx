...
function PlayerSkeleton() {
    return (
        <div className="space-y-6">
            {/* Hero skeleton */}
            <div className="bg-gradient-to-r from-[#0f172a] via-[#1e3a8a] to-[#0891b2] rounded-2xl p-8">
                <div className="flex flex-col md:flex-row items-center gap-8">
                    <Skeleton className="w-48 h-48 rounded-xl bg-white/10" />
...
function TeamCard({ teamId }: { teamId: number }) {
    ...
    return (
        <Link href={`/team/${teamId}`}>
            <div className="bg-white rounded-xl p-4 border border-gray-100 hover:border-kmff-blue/30 hover:shadow-md transition-all flex items-center gap-4">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                {isLoading ? (
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="relative bg-gradient-to-r from-[#0f172a] via-[#1e3a8a] to-[#0891b2] rounded-2xl overflow-hidden">
                            {/* Back button */}
                            ...
                            <div className="flex flex-col md:flex-row items-center md:items-end gap-6 p-8 pt-14">
                                {/* Player Photo */}
                        ...
                        <div className="lg:grid lg:grid-cols-12 lg:gap-8">
                            ...
                            <div className="lg:col-span-8 space-y-6">
                                    ...
                                    <div className="p-6">
                                        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
                                            <div className="bg-gray-50 rounded-xl p-4 text-center hover:shadow-md transition-shadow">
                                                <div className="text-3xl font-bold text-gray-900">{stats?.totalMatches || 0}</div>
                                                <div className="text-gray-500 text-sm mt-1">Матчей</div>
                                            </div>
                                            <div className="bg-gray-50 rounded-xl p-4 text-center hover:shadow-md transition-shadow">
                                                <div className="text-3xl font-bold text-green-600">{stats?.totalGoals || 0}</div>
                                                <div className="text-gray-500 text-sm mt-1">Голов</div>
                                            </div>
                                            <div className="bg-gray-50 rounded-xl p-4 text-center hover:shadow-md transition-shadow">
                                                <div className="text-3xl font-bold text-yellow-600">{stats?.yellowCards || 0}</div>
                                                <div className="text-gray-500 text-sm mt-1">Желтых</div>
                                            </div>
                                            <div className="bg-gray-50 rounded-xl p-4 text-center hover:shadow-md transition-shadow">
                                                <div className="text-3xl font-bold text-red-600">{stats?.redCards || 0}</div>
                                ...
                                {/* Match Results */}
                                {stats && (
                                    <div className="bg-gradient-to-br from-[#1e3a8a] via-[#172554] to-[#1e3a8a] rounded-xl p-6 shadow-lg">
                                        ...
                                        <div className="grid grid-cols-3 gap-6 text-center">
                                            ...
                                            <div className="bg-white/5 rounded-xl p-4">
                                                <div className="text-4xl font-bold text-gray-300">{stats.draws}</div>
                                        ...
                                        {stats.teamWinRate > 0 && (
                                            <div className="mt-6 pt-4 border-t border-white/10 text-center">
                                                ...
                                                <span className="text-white font-bold ml-2 text-xl">{stats.teamWinRate.toFixed(1)}%</span>
                                            </div>
                                        )}
                                    </div>
                                )}
                                ...
                                {stats?.tournaments && stats.tournaments.length > 0 && (
                                    <div className="bg-white rounded-xl border border-gray-100 overflow-hidden">
                                        <div className="px-6 py-4 border-b border-gray-100 flex items-center gap-2">
                                            ...
                                            <h3 className="text-lg font-bold text-gray-900">Турниры</h3>
                                        </div>
                                                ...
                                                <tbody>
                                                    {stats.tournaments.map((tournament, index) => (
                                                        <tr key={index} className="border-b border-gray-50 hover:bg-gray-50 transition-colors">
                                                            ...
                                                            <td className="py-4 px-4 text-center font-bold text-green-600">{tournament.playerGoals}</td>
                                                        </tr>
                                                    ))}
                                                </tbody>
                                            </table>
