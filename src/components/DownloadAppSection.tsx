    ...
    return (
        <section className="relative overflow-hidden bg-gradient-to-br from-blue-50 to-white py-16 lg:py-24">
            ...
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
                ...
                <div className="absolute top-1/2 right-0 w-64 h-64 bg-blue-200 rounded-full blur-3xl opacity-30"></div>
            </div>
                ...
                <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20">
                    ...
                    <div className="flex-1 max-w-2xl text-center lg:text-left">
                        ...
                        <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-6 leading-tight">
                            Весь мини-футбол <br className="hidden md:block" />
                        ...
                        <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                            Следите за результатами, статистикой и новостями вашей любимой команды в удобном формате. Получайте уведомления о матчах и будьте в курсе всех событий лиги.
                        </p>
                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start mb-10">
                            ...
                            <a 
                                ...
                                className="group flex items-center gap-3 bg-gray-900 text-white px-5 py-3 rounded-xl hover:bg-gray-800 transition-all duration-300 hover:-translate-y-1 shadow-lg hover:shadow-xl w-full sm:w-auto min-w-[180px]"
                            >
                            ...
                            {/* Google Play Button */}
                            <a 
                                href="https://play.google.com/store/apps/details?id=kz.llf.onesportone&hl=ru" 
                                target="_blank" 
                                rel="noopener noreferrer"
                                className="group flex items-center gap-3 bg-gray-900 text-white px-5 py-3 rounded-xl hover:bg-gray-800 transition-all duration-300 hover:-translate-y-1 shadow-lg hover:shadow-xl w-full sm:w-auto min-w-[180px]"
                            >
                                <div className="shrink-0">
                                    <svg viewBox="0 0 512 512" width="24" className="fill-current">
                        ...
                        <div className="flex flex-wrap justify-center lg:justify-start gap-4 text-sm text-gray-500 font-medium">
                    ...
                    <div className="flex-1 relative w-full max-w-md lg:max-w-lg">
                        <div className="relative aspect-[4/5] w-full">
                            ...
                            <Image
                                src="/app-mockup.png"
                                alt="MiniFootball App Interface"
                                fill
