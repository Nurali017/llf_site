    ...
    return (
        <div className="space-y-6">
            {firstHalfEvents.length > 0 && (
                <div>
                    <h4 className="text-sm font-bold text-gray-500 uppercase mb-3 text-center">1-й тайм</h4>
                    <div>
            ...
            {secondHalfEvents.length > 0 && (
                <div>
                    <h4 className="text-sm font-bold text-gray-500 uppercase mb-3 text-center">2-й тайм</h4>
                    <div>
            ...
            {match.penalty_events.length > 0 && (
                <div>
                    <h4 className="text-sm font-bold text-gray-500 uppercase mb-3 text-center">Серия пенальти</h4>
                    <div>
        ...
        <div className="space-y-2">
            {players.map(player => (
                <Link key={player.id} href={`/player/${player.id}`}>
                    ...
                    >
                        <span className="w-6 h-6 bg-kmff-blue text-white rounded-full flex items-center justify-center text-xs font-bold">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white rounded-xl p-6 border border-gray-100 shadow-sm">
                            ...
                            <div className="flex items-center justify-center gap-4 md:gap-8">
                                ...
                                <Link href={`/team/${match.team_1.id}`} className="flex flex-col items-center text-center flex-1 hover:opacity-80 transition-opacity">
                                    ...
                                    <h2 className="font-bold text-gray-900 text-sm md:text-base">{match.team_1.name}</h2>
                                </Link>
                                ...
                                <Link href={`/team/${match.team_2.id}`} className="flex flex-col items-center text-center flex-1 hover:opacity-80 transition-opacity">
                                    ...
                                    <h2 className="font-bold text-gray-900 text-sm md:text-base">{match.team_2.name}</h2>
                                </Link>
                            </div>
                        ...
                        <div className="bg-white rounded-xl p-6 border border-gray-100 shadow-sm">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <h4 className="font-bold text-gray-700 mb-3">{match.team_1.name}</h4>
                                    <TeamLineup team={match.team_1} isHome={true} />
                                </div>
                                <div>
                                    <h4 className="font-bold text-gray-700 mb-3 md:text-right">{match.team_2.name}</h4>
